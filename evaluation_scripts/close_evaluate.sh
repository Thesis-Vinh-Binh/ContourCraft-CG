# python evaluation_scripts/close_evaluate.py --method llava --path close_image_scan_img_recon
python evaluation_scripts/close_evaluate.py --method llava --folder close_image_scan_img_recon --metrics chamfer fscore
# python evaluation_scripts/close_evaluate.py --method llava --path close_image_scan_blip_img_recon
