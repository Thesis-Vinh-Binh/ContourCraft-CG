...
def get_all_paths_garmentcode(tmptrial=False):
    ...
    if not tmptrial:
        ...
        saved_folder = '/ps/scratch/ps_shared/sbian/hood_simulation_garmentcode_v2_physics_hood'
        saved_folder_final = '/ps/scratch/ps_shared/sbian/hood_simulation_garmentcode_v2_physics_hood'
...
if __name__ == "__main__":
    ...
    out_template_path = os.path.join(saved_folder, f'{args.index}', 'motion_0', 'combined_garment.pkl'). \
        replace('hood_simulation_garmentcode_v2_physics_hood', 'hood_simulation_garmentcode_v2_physics')
